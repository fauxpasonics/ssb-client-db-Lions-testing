...
GO
ALTER TABLE [dbo].[FactAttendance_V2] ADD CONSTRAINT [PK_dbo_FactAttendance_V2_FactAttendanceId] PRIMARY KEY CLUSTERED  ([FactAttendanceId]) WITH (DATA_COMPRESSION = PAGE)
GO
...
GO
CREATE NONCLUSTERED INDEX [NCIX_FactAttendance_V2_ETL__UpdatedDate] ON [dbo].[FactAttendance_V2] ([ETL__UpdatedDate]) WITH (DATA_COMPRESSION = PAGE)
GO
