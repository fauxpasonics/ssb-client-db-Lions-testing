CREATE TABLE [segmentation].[SegmentationFlatDataad5d7aa7-4785-4d1a-9ee0-061ee5fe8002]
(
...
[Ticketing_Acct_ID] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Order_Date] [date] NULL,
[Season_Year] [int] NULL,
[Season_Is_Active] [bit] NOT NULL,
...
[Offer_Code] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Offer_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Is_Broker] [bit] NULL,
[Is_Renewal] [bit] NULL,
[Section_Name] [nvarchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Row_Name] [nvarchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[First_Seat] [decimal] (10, 0) NULL,
[Qty_Seat] [int] NULL,
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataad5d7aa7-4785-4d1a-9ee0-061ee5fe8002] ADD CONSTRAINT [pk_SegmentationFlatDataad5d7aa7-4785-4d1a-9ee0-061ee5fe8002] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataad5d7aa7-4785-4d1a-9ee0-061ee5fe8002] ON [segmentation].[SegmentationFlatDataad5d7aa7-4785-4d1a-9ee0-061ee5fe8002] ([_rn])
GO
