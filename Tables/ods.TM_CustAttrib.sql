...
GO
ALTER TABLE [ods].[TM_CustAttrib] ADD CONSTRAINT [PK__TM_CustA__3213E83FA40CD818] PRIMARY KEY CLUSTERED  ([id]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_ods_TM_CustAttrib_UpdateDate] ON [ods].[TM_CustAttrib] ([UpdateDate]) WITH (DATA_COMPRESSION = PAGE)
GO
