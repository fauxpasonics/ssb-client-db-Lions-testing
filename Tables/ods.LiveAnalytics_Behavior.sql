CREATE TABLE [ods].[LiveAnalytics_Behavior]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_C__77BD01C9] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_U__78B12602] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_I__79A54A3B] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[LiveAnalytics_Behavior] ADD CONSTRAINT [PK__LiveAnal__7EF6BFCDB3987209] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
