...
GO
CREATE NONCLUSTERED INDEX [NCIX_FactInventory_V2_FactHeldSeatsId_DimSeatStatusId] ON [dbo].[FactInventory_V2] ([FactHeldSeatsId], [DimSeatStatusId]) WITH (DATA_COMPRESSION = PAGE)
GO
