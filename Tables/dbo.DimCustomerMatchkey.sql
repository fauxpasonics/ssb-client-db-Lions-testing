...
[MatchkeyValue] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomerMatchkey_MatchkeyID] ON [dbo].[DimCustomerMatchkey] ([MatchkeyID]) INCLUDE ([DimCustomerID], [MatchkeyValue])
GO
