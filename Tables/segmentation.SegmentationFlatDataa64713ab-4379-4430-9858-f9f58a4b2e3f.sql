CREATE TABLE [segmentation].[SegmentationFlatDataa64713ab-4379-4430-9858-f9f58a4b2e3f]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataa64713ab-4379-4430-9858-f9f58a4b2e3f] ADD CONSTRAINT [pk_SegmentationFlatDataa64713ab-4379-4430-9858-f9f58a4b2e3f] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataa64713ab-4379-4430-9858-f9f58a4b2e3f] ON [segmentation].[SegmentationFlatDataa64713ab-4379-4430-9858-f9f58a4b2e3f] ([_rn])
GO
