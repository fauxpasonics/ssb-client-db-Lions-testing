...
GO
CREATE NONCLUSTERED INDEX [NCIX_DimSeat_V2_ETL__SourceSystem_ETL__SSID_TM_section_id] ON [dbo].[DimSeat_V2] ([ETL__SourceSystem], [ETL__SSID_TM_section_id], [ETL__SSID_TM_row_id], [ETL__SSID_TM_seat]) WITH (DATA_COMPRESSION = PAGE)
GO
