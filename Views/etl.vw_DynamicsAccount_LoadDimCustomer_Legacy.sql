...
CREATE VIEW [etl].[vw_DynamicsAccount_LoadDimCustomer_Legacy] AS ( --Change "Source" to the correct source
 
    SELECT *
    /*Name*/
    , HASHBYTES('sha2_256',
...
            , 'Legacy_Dynamics_Account' AS [SourceSystem] --Put source name such as TM or CRM_Contact
...
            , CAST(z.lions_fulfillmentmanagerid AS NVARCHAR (50)) AS [AccountRep] 
...
        --SELECT COUNT(*)           
        FROM Lions_Reporting.prodcopy.account_legacy z WITH (NOLOCK) 
